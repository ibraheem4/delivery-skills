...
For core engineering skills (testing, code review, security, etc.), see the public [agent-skills](https://github.com/lucitra/agent-skills) repo. These skills build on top of those patterns with executable workflows.
...
These skills reference patterns from the public [agent-skills](https://github.com/lucitra/agent-skills) repo:
