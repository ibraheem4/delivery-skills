...
Parse `$ARGUMENTS`:
- **URL or app name**: `http://localhost:3100`, `https://dev.acme.ai`, or `studio` (for Tauri app)
...
|--------|-----------|-------|
| `studio` or `tauri` | `mcp__acme-studio__tauri_*` | Tauri debug server on port 9333 |
| `http://localhost:*` | `mcp__acme-studio__web_*` | Browser automation via Playwright |
| Any URL | `mcp__acme-studio__web_*` | Browser automation via Playwright |
| Desktop screenshot | `mcp__acme-studio__desktop_screenshot` | macOS native capture |
